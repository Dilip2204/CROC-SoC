...
├── sw/                    # Software (RISC-V C/asm, makefiles)
├── verilator/             # Verilator simulation scripts
├── vsim/                  # Questa/Modelsim simulation scripts
├── yosys/                 # Synthesis scripts & netlist output
├── openroad/              # Place & Route scripts
├── klayout/               # Layout finishing & GDS generation
├── xilinx/                # FPGA build scripts (Genesys2)
├── scripts/               # Utility scripts (env.sh, linting, Docker)
├── testbench/             # Custom testbenches
├── results/               # Simulation, synthesis, layout outputs
├── ihp13/                 # IHP 130nm PDK files
├── .github/               # CI workflows
├── Bender.yml             # Dependency manifest
├── Bender.lock            # Locked dependencies
└── README.md              # This file
```
...
# Linting
scripts/run_checks.sh --sv --python --cxx --license
```
